...
[![100+ Patterns](https://img.shields.io/badge/patterns-100%2B-orange.svg)](#table-of-contents)
...
- **100 DataWeave patterns** across 20 categories — each with realistic input/output, working code, and alternative syntax
...
| 19 | [AI Integration](#19--ai-integration) | 2 patterns | Advanced |
| 20 | [Utility Modules](#20--utility-modules) | 5 patterns | Intermediate → Advanced |
...
| Pattern | File | Difficulty |
|---------|------|-----------|
| SSE Event Stream | [`sse-event-stream.dwl`](patterns/16-event-driven/sse-event-stream.dwl) | Advanced |
| Avro Schema Validation | [`avro-schema-validation.dwl`](patterns/16-event-driven/avro-schema-validation.dwl) | Advanced |

### 17 — Math & Precision

| Pattern | File | Difficulty |
|---------|------|-----------|
| Decimal Precision | [`decimal-precision.dwl`](patterns/17-math-precision/decimal-precision.dwl) | Intermediate |

### 18 — Observability

| Pattern | File | Difficulty |
|---------|------|-----------|
| Structured Logging | [`structured-logging.dwl`](patterns/18-observability/structured-logging.dwl) | Intermediate |

### 19 — AI Integration

| Pattern | File | Difficulty |
|---------|------|-----------|
| AI Prompt Builder | [`ai-prompt-builder.dwl`](patterns/19-ai-integration/ai-prompt-builder.dwl) | Advanced |
| AI Response Parser | [`ai-response-parser.dwl`](patterns/19-ai-integration/ai-response-parser.dwl) | Advanced |

### 20 — Utility Modules

| Pattern | File | Difficulty |
|---------|------|-----------|
| MIME Type Parser | [`mime-type-parser.dwl`](patterns/20-utility-modules/mime-type-parser.dwl) | Intermediate |
| Tree Traversal | [`tree-traversal.dwl`](patterns/20-utility-modules/tree-traversal.dwl) | Advanced |
| Diff Comparison | [`diff-comparison.dwl`](patterns/20-utility-modules/diff-comparison.dwl) | Advanced |
| Execution Timer | [`execution-timer.dwl`](patterns/20-utility-modules/execution-timer.dwl) | Intermediate |
| URL Parse & Build | [`url-parse-build.dwl`](patterns/20-utility-modules/url-parse-build.dwl) | Intermediate |
...
Part of [MuleSoft Cookbook](https://github.com/shakarbisetty/mulesoft-cookbook) — practical recipes for the MuleSoft community.
